...
public class MenuUtilTest {
	...
	public  String getAccessToken() throws WeixinException{
		...
		String url = URL_ACCESSTOKEN + "?" + "grant_type="+ConfigTest.grant_type+"&appid="+ConfigTest.APPID+"&secret="+ConfigTest.SECRET;
	 ...
	 * @throws WeixinException
	 */
	public  void create(String json) throws WeixinException{
	 ...
	 * @throws WeixinException
	 */
	public  String get() throws WeixinException{
