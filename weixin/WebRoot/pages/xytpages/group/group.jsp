  ...
  <body class="g-classDetail">
       ...
       <div class="group-main">
           <div class="group-warp">
               ...
               <p class="group-title p-h">课程名称：${groupOrder.xytCourse.courseName}</p>
               ...
               <c:if test="${(groupOrder.xytTercherInfo != null)}">
	               <P class="group-img">
	               <img src="${basePath}${groupOrder.xytTercherInfo.photoPath}" class="group-img-circle" style="display: inline; visibility: visible;"/>
	               </P>
