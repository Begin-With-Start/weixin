...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    <IMG id=u0 src="file/mihoutao1.jpg" class="u0" >
    </div>
	...
	<DIV>
		<IMG id=u0 src="file/mihoutao2.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
	...
	<DIV>
		<IMG id=u0 src="file/mihoutao3.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
