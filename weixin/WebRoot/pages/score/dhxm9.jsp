...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    <IMG id=u0 src="file/shiliu.jpg" class="u0" >
    </div>
	...
	<DIV>
		<IMG id=u0 src="file/shiliu2.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
	<div class="content">
         <ol>
             <li>
     ...
     <DIV>
		<IMG id=u0 src="file/shiliu3.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
