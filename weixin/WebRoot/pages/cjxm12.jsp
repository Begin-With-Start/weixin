...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    ...
	    <IMG id=u0 src="file/shanjinquan1.jpg" class="u0" >
    </div>
	...
	<DIV id=u7_rtf>
     ...
     <div class="content">
         <ol>
         	<li>
                 <b>获得本次山井泉桶装水的幸运粉丝为：</b>
                 </br><span style = "color:red; asign:center">133****3222</span>
                 </br><span style = "color:red; asign:center">183****4986</span>
                 </br><span style = "color:red; asign:center">151****5146</span>
                 </br><span style = "color:red; asign:center">158****6291</span>
                 </br><span style = "color:red; asign:center">133****9255</span>
             </li>
             
             <li>
                 <b>奖品名称：</b>
                 <span>山井泉桶装水4桶/价值48元</span>
             </li>
             ...
             <li>
                 <b>抽奖时段：</b>
                 <span>12月1号10:00-12月3号17:00</span>
             </li>
                          
             <li>
                 <b>领奖方式：</b>
                 <span>配送范围：长沙主城区。送水热线：0731-85180007</span>
             </li>
         </ol>
     </div>
	...
	<DIV>
		<IMG id=u0 src="file/shanjinquanjianjie.jpg" class="u0"    style="width:100%; height: 536px">
		<DIV align="center" style="color:red; font-size: 22">
			<b><span>山井泉桶装水</span></b>
		</DIV>
	</DIV>
	...
	<DIV>
	<IMG id=u0 src="file/zhijianbaogao.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
