		...
		PicCarousel.prototype = {
			...
			setPosterPost:function(){
				...
				rightSlice.each(function(i){
					...
					$(this).css({
							...
							height:rh,
							opacity:1/(++j),
							left:fixOffsetLeft+(++i)*(gap-30)-rw+60,
							top:me.setVertucalAlign(rh-(i*160))
					});
				...
				leftSlice.each(function(i){
					$(this).css({
							...
							opacity:1/oloop,
							left:i*(gap-30)+140,
							top:me.setVertucalAlign(rh+740-(i*50))
					});
			...
			setSettingValue:function(){
				...
				me.posterFirstItem.css({
					...
					top: me.setVertucalAlign(me.settings.posterHeight+150),
					left:200,
