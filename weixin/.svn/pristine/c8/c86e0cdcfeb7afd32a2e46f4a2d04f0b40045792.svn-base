   ...
   window._msgZindex = window._msgZindex || 200000;
    ...
    this.showMessageBox=function (wTitle,content,wWidth,type,confirmFun,cancelFun)
    {
      ...
      if(typeof(content)=='string'){
            ...
            styleStr="left:"+(obj.getClientWidth()- wWidth)/2+"px;position:absolute;width:"+wWidth+"px;z-index:"+window._msgZindex++ +";top:" +(80+obj.getScrollTop()) +'px';//+obj.getScrollTop()
    ...
    this.setDivSize=function(){
        ...
        if(messageDiv!=null){
             messageDiv.style.top=(80 + obj.getScrollTop()) +'px';//( obj.getClientHeight() -  messageDiv.offsetHeight)/2 + obj.getScrollTop()
    ...
    this.setMessageBoxTop=function(p)
    {
        ...
        var toTop =toTop = 80 + obj.getScrollTop();//( obj.getClientHeight() -  messageDiv.offsetHeight)/2 + obj.getScrollTop();
