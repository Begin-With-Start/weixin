  ...
  <div class="m-nav2">
   ...
   <div class="private-dialogue-warp">
       ...
       <c:forEach items="${userAttantionList}" var="userAttantion" varStatus="i">
               <dl class="private_SRLl clearfix" onclick="javascript:location.href='${basePath}xyt/userInfo!showHisHome.action?userId=${user.rid}&hisUserId=${userAttantion.attantionUser.rid}'" >
		           <dt class="face">
		           	   <img src="${userAttantion.attantionUser.headimgurl}" class="img-circle" style="display:block; visibility: visible;">
		           </dt>
                   <dd class="private-name content af_content">
                       ${userAttantion.attantionUser.nickname}
                   </dd>
		       </dl>
