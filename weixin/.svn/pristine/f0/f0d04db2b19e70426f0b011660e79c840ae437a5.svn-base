...
function leaveMessage(){
	...
	$.post('${basePath}xyt/XytMessageAction!saveCollegeMessage.action',{userid:userid,content:content,collegeId:collegeId},function(data){
...
function leaveMessageAnonymity(){
	...
	var collegeId = ${collegeId};
	var content = document.getElementById("messageText").value 
	$.post('${basePath}xyt/XytMessageAction!saveCollegeMessageAnonymity.action',{userid:userid,content:content,collegeId:collegeId},function(data){
		 if(data.result == "success")
		{
			window.location.reload(); 
		}else{
...
function hidedialog2()
{
 ...
 <div class="mycampus-main">
   <div class="mycampus-wrap">
     ...
     <img id = 'collegeimg' src="${basePath}${xytCollege.photoPath}" >
     </div>
