...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    <IMG id=u0 src="file/hongbeibao1.jpg" class="u0" >
    </div>
	...
	<DIV id=u7_rtf>
     ...
     <div class="content">
         <ol>
             <li>
                 <b>物品名称：</b>
                 <span>价值866元的Victoria Cross背包</span>
             </li>
         </ol>
     </div>
	...
	<div class="content">
         <ol>
             <li>
                 <b>领取方式：</b>
                 <span>现场领取:长沙市天心区韶山南路258号潇湘晨报社新媒体楼，联系电话：0731-87961225</span>
             </li>
         </ol>
     </div>
	<DIV>
		<IMG id=u0 src="file/hongbeibao2.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
	 <div class="content">
         <ol>
             <li>
     ...
     <DIV>
		<IMG id=u0 src="file/hongbeibao3.jpg" class="u0"    style="width:100%; height: 340px">
	</DIV>
