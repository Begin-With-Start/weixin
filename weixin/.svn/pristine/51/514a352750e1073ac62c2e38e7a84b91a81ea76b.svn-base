...
{
	var user = "<%=user%>";
	window.location.href='/weixin/pages/inputniuroubillnumber.jsp?user='+user;
}
...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    ...
	    <IMG id=u0 src="file/niurou3.jpg" class="u0" >
    </div>
	...
	<DIV id=u7_rtf>
     ...
     <div class="content">
         <ol>
         	 ...
         	 <li>
                 <b>中奖公布：</b>
                 <span style = "color:red">2015年10月26日上证收盘指数：3429.58，倒序排列为：859243。</br>本次抽奖活动中奖编号为：860541。</br>电话号码：159****5990。</span>
             </li>
             ...
             <li>
                 <b>奖品数量：</b>
                 <span>1份(108g * 4袋)</span>
             </li>
             
             <li>
                 <b>抽奖时段：</b>
                 <span>10月23号9:30-10月26号15:00</span>
             </li>
             
             <li>
                 <b>开奖时间：</b>
                 <span>10月26号17:00</span>
             </li>
             
             <li>
                 <b>领奖方式：</b>
                 <span>现场领取，10月27日上午9点至下午5点，长沙市天心区韶山南路258号潇湘晨报社新媒体楼，联系电话：073187961225</span>
             </li>
         </ol>
     </div>
	...
	<DIV>
		<IMG id=u0 src="file/niurou4.jpg" class="u0"    style="width:100%; height: 236px">
		<DIV align="center" style="color:red; font-size: 22">
			<b><span>邵阳秘制牙签牛肉一份</span></b>
		</DIV>
	...
	<DIV>
	<IMG id=u0 src="file/niurou2.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
	
	<div class="content">
         <ol>
             <li>
                 <b>邵阳秘制牙签牛肉香酥里嫩，肉质鲜美，劲道十足，正宗纯牛肉，经历多道工序制造纯天然没味，细细品尝，仿佛置身于美丽的大草原。</b>
             </li>
         </ol>
    </div>
	
	<DIV>
	<IMG id=u0 src="file/niurou5.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
...
<div class="floatBtn" id="floatBtn">
   <div class="bingoBtn" onClick="cj()">立即抽奖</div>
