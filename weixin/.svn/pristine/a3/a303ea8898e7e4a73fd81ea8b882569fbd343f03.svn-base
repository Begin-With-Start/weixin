...
var messageBox; (function(){ messageBox = new __messageBox(); })(); 
  ...
  <BODY>
    ...
    <div class="big-pic">
	    <IMG id=u0 src="file/chezhan.jpg" class="u0" >
    </div>
	...
	<div class="content">
         <ol>
             <li>
                 <b>领取方式：</b>
                 <span>到车展现场购票亭，“大麦网兑票处”窗口，凭手机号领取。</span>
             </li>
         </ol>
     </div>
	...
	<div class="content">
         <ol>
             <li>
                 <b>还记得《速度与激情7》里那部驰骋在空中的红色超级跑车吗？没错！它就是当今世界上最贵的超级跑车--Lykan（莱肯），这部只有电影中才能看得到的神车将迎来它的中部首秀！</b>
             </li>
         </ol>
    </div>
    
    <DIV>
		<IMG id=u0 src="file/paoche1.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
	
	<DIV>
		<IMG id=u0 src="file/paoche2.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
	
	<DIV>
		<IMG id=u0 src="file/paoche3.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
	
	<DIV>
		<IMG id=u0 src="file/paoche4.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
	
	<DIV>
		<IMG id=u0 src="file/paoche5.jpg" class="u0"    style="width:100%; height: 236px">
	</DIV>
     
	<div class="content">
         <ol>
             <li>
                 <b>12月10日-14日，第十一届中国（长沙）国际汽车博览会将在国际会展中心举行，作为历届中规模最大的一次车展，沸腾了整个大湖南！</b>
             </li>
         </ol>
    </div>
